...
descriptions, for the most cases, relative captioner proved to give decent descriptions for images: 
...
for reading user messages. But we are working on a better demo to the more 
useful case of presenting multiple images per round. 
