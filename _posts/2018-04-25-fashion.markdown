...
language understanding. A few interesting applications scenarios have been explored by 
...
challenging context: we proposed a novel framework of image retrieval system which learns to seek 
